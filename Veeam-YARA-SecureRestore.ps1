...
function Invoke-ProcessWithTimeout {
    ...
    # ProcessStartInfo.ArgumentList is .NET Core 2.1+ only and does NOT exist on
    # .NET Framework 4.x (Windows PowerShell 5.1). Build the argument string
    # manually so this works identically on PS5.1 and PS7.
